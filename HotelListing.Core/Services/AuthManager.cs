...
namespace HotelListing.Core.Services
{
    public class AuthManager : IAuthManager
    {
        ...
        public async Task<string> CreateRefreshToken()
        {
            ...
            var newRefreshToken = await _userManager.GenerateUserTokenAsync(_user, "HotelListing", "RefreshToken");
            var result = await _userManager.SetAuthenticationTokenAsync(_user, "HotelListing", "RefreshToken", newRefreshToken);
        ...
        public async Task<TokenRequest> VerifyRefreshToken(TokenRequest request)
        {
            ...
            try
            {
                var isValid = await _userManager.VerifyUserTokenAsync(_user, "HotelListing", "RefreshToken", request.RefreshToken);
                if (isValid)
                {
